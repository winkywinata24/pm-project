                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    shadow-sm sm:rounded-lg">
                        <form onSubmit={onSubmit}
                            ...
                            <div className="mt-4">
                                <InputLabel htmlFor="user_email_verified_at" value="User Email Verified At"/>
                                <TextInput
                                    id="user_email_verified_at"
                                    type="date"
                                ...
                                />
                                <InputError message={errors.email_verified_at} className="mt-2"/>
                            </div>
